                            ...
                            <div>
                                <div className="mb-1"> 
                                    ...
                                    <div className="flex">
                                        ...
                                        />
                                        <button 
                                            className="float-right left-2 w-28 relative block appearance-none rounded-t-2xl rounded-b-2xl border border-gray- px-3 py-2 text-gray-900 bg-gray-400 placeholder-gray-400 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                                            >우편번호 검색</button>
                                    </div>
                                </div>
                            <div className="mb-1">
